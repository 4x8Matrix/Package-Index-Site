...
> ClassIndex.FetchClassIcon( `className` [string](https://create.roblox.com/docs/en-us/luau/strings) ) ->  \{ Image: string, ImageRectOffset: Vector2, ImageRectSize: Vector2 } 
...
> ClassIndex.FetchClassMemberTags( `className` [string](https://create.roblox.com/docs/en-us/luau/strings), `memberName` [string](https://create.roblox.com/docs/en-us/luau/strings) ) ->  \{ Hidden: boolean?, NotReplicated: boolean?, ReadOnly: boolean?, Deprecated: boolean? } 
